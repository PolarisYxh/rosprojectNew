...
#include "kinova_arm_moveit_demo/PhantomButtonEvent.h"
#include "kinova_arm_moveit_demo/OmniFeedback.h"
//#include <pthread.h>
...
public:
	...
	void init(OmniState *s) {
		...
		button_topic <<"button";
		button_pub = n.advertise<kinova_arm_moveit_demo::PhantomButtonEvent>(button_topic.str(), 100);
	...
	/*******************************************************************************
	 ROS node callback.
	 *******************************************************************************/
	void force_callback(const kinova_arm_moveit_demo::OmniFeedbackConstPtr& omnifeed) {
...
//			}
			kinova_arm_moveit_demo::PhantomButtonEvent button_event;
