...
(cl:defmethod cl:initialize-instance :after ((m <PhantomButtonEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PhantomButtonEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_arm_moveit_demo-msg:<PhantomButtonEvent> is deprecated: use kinova_arm_moveit_demo-msg:PhantomButtonEvent instead.")))

(cl:ensure-generic-function 'grey_button-val :lambda-list '(m))
(cl:defmethod grey_button-val ((m <PhantomButtonEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_arm_moveit_demo-msg:grey_button-val is deprecated.  Use kinova_arm_moveit_demo-msg:grey_button instead.")
  (grey_button m))

(cl:ensure-generic-function 'white_button-val :lambda-list '(m))
(cl:defmethod white_button-val ((m <PhantomButtonEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_arm_moveit_demo-msg:white_button-val is deprecated.  Use kinova_arm_moveit_demo-msg:white_button instead.")
  (white_button m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PhantomButtonEvent>)))
  ...
  "kinova_arm_moveit_demo/PhantomButtonEvent")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PhantomButtonEvent)))
  "Returns string type for a message object of type 'PhantomButtonEvent"
  "kinova_arm_moveit_demo/PhantomButtonEvent")
