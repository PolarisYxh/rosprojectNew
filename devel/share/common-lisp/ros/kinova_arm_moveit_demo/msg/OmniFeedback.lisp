...
(cl:in-package kinova_arm_moveit_demo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <OmniFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OmniFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_arm_moveit_demo-msg:<OmniFeedback> is deprecated: use kinova_arm_moveit_demo-msg:OmniFeedback instead.")))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_arm_moveit_demo-msg:force-val is deprecated.  Use kinova_arm_moveit_demo-msg:force instead.")
  (force m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_arm_moveit_demo-msg:position-val is deprecated.  Use kinova_arm_moveit_demo-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'lock-val :lambda-list '(m))
(cl:defmethod lock-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_arm_moveit_demo-msg:lock-val is deprecated.  Use kinova_arm_moveit_demo-msg:lock instead.")
  (lock m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OmniFeedback>)))
  ...
  "kinova_arm_moveit_demo/OmniFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OmniFeedback)))
  "Returns string type for a message object of type 'OmniFeedback"
  "kinova_arm_moveit_demo/OmniFeedback")
